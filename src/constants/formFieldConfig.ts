...
export const fieldConfigsUpdateAndTVShow: Record<string, FieldConfig> = {
  ...
  last_air_date: { label: 'Last Air Date', type: 'date', min: '1900-01-01', max: '2100-12-31', required: false },
  first_air_date: { label: 'First Air Date', type: 'date', min: '1900-01-01', max: '2100-12-31', required: false },
  number_of_episodes: { label: 'Number of Episodes', type: 'number', placeholder: 'Enter number of episodes', min: '1', max: 1000, required: false },
  number_of_seasons: { label: 'Number of Seasons', type: 'number', placeholder: 'Enter number of seasons', min: '1', max: 100, required: false },
};
