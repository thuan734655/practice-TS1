...
export const fieldConfigsTVShow: Record<string, FieldConfig> = {
  ...
  episode_run_time: { label: 'Episode Run Time', type: 'number', placeholder: 'Enter run time', min: '1', max: 10000, required: true },
  genres: { label: 'Genres', type: 'text', placeholder: 'Enter genres (comma separated)', required: true },
  status: { label: 'Status', type: 'text', placeholder: 'Enter video status', required: true },
  ...
  number_of_episodes: { label: 'Number of Episodes', type: 'number', placeholder: 'Enter number of episodes', min: '1', max: 10000, required: true },
  number_of_seasons: { label: 'Number of Seasons', type: 'number', placeholder: 'Enter number of seasons', min: '1', max: 9999, required: true },
};
...
export const fieldConfigMovies: Record<string, FieldConfig> = {
  ...
  episode_run_time: { label: 'Episode Run Time', type: 'number', placeholder: 'Enter run time', min: '0', max: 10000, required: true },
  genres: { label: 'Genres', type: 'text', placeholder: 'Enter genres (comma separated)', required: true },
};
